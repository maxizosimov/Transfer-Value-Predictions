...
(train_data[train_data$age < 21
            & train_data$year < 2015,]) # About 1 million
...
plot_player_value_over_time("Bukayo Saka", X_test, test_data, gibbs_samples_w, gibbs_samples_sigmay, ci=0.9)
...
plot_player_value_over_time("Bukayo Saka", X_full_test, full_test_data, gibbs_samples_w, gibbs_samples_sigmay, ci=0.9)
